...
import ProjectViewDeliverires from "./project-view-deliveries";
...
type Tab = "general" | "families" | "assistances" | "members" | "deliveries";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-shrink-0 border-b border-gray-200 bg-white">
        <div
          ...
          className="flex overflow-x-auto scrollbar-hide md:overflow-x-visible"
          style={{
            scrollbarWidth: 'none',
        ...
        >
          {tabs.map((tab) => (
            <button
              ...
              className={`flex-shrink-0 flex items-center gap-2 px-4 md:px-6 py-3 md:py-4 font-medium transition-colors border-b-2 whitespace-nowrap ${
                activeTab === tab.key
