...
const adminSlides: Slide[] = [
...

  {
    ...
    visual: (
      <div className="mt-4 space-y-2">
        ...
        <p className="text-xs text-gray-400 text-center font-bold pt-1">Members must exsit before creating projects</p>
      </div>
    ),
  },
      ...
      <div className="mt-4 border border-gray-100 rounded-xl overflow-hidden">
        <div className="px-4 py-3 border-b border-gray-100">
          ...
          <div className="flex gap-4 text-xs text-gray-400">
            <span className="flex">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4 text-gray-400 mr-2">
            ...
            <span className="flex text-xs text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4 text-gray-400 mr-2">
               ...
               2 Assistance types</span>
          </div>
        </div>
        <div className="px-4 py-2 bg-amber-50 flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-5 text-amber-500 text-xs">
            <path stroke-linecap="round" stroke-linejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
          </svg>
          <span className="text-xs text-amber-600 font-medium">You cannot modify field records, only enumerators can.</span>
        </div>
      </div>
    ),
  },
...

  {
    ...
    title: "Watch the Full Setup Guide",
    description: "For more details, Watch our step-by-step video walkthrough covering everything from account setup to your first project, start to finish.",
    visual: (
      <div className="mt-4 space-y-3">
        <a
          href="https://www.loom.com/share/4d0a95117d2642bea27a1c68d756a609"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-4 bg-gray-900 rounded-xl px-4 py-4 hover:bg-gray-800 transition-colors cursor-pointer"
        >
          {/* Play button */}
          <div className="w-12 h-12 rounded-xl bg-primary flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-white ml-0.5">
              <path fillRule="evenodd" d="M4.5 5.653c0-1.427 1.529-2.33 2.779-1.643l11.54 6.347c1.295.712 1.295 2.573 0 3.286L7.28 19.99c-1.25.687-2.779-.217-2.779-1.643V5.653Z" clipRule="evenodd" />
            </svg>
          </div>

          <div className="flex-1 min-w-0">
            <p className="text-sm font-bold text-white">Kora: Complete Setup Walkthrough</p>
            <p className="text-xs text-gray-400 mt-0.5">Watch on Loom · Full tutorial</p>
          </div>

          {/* External link icon */}
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-4 text-gray-500 group-hover:text-gray-300 flex-shrink-0 transition-colors">
            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 5.25 21h10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" />
          </svg>
        </a>

        <p className="text-xs text-center text-gray-400">
          Opens in a new tab, no account needed to watch
        </p>
      </div>
    ),
  },
    ...
    visual: (
      <div className="mt-4 space-y-3">
        <div
          ...
          className="flex items-center gap-3 bg-primary/5 border border-primary/20 rounded-xl px-4 py-4"
        >
...
const collaboratorSlides: Slide[] = [
  {
    ...
    visual: (
      <div className="mt-4 flex items-center gap-2">
        {[
          { label: "Enumerator", icon: <><div><img src={welcome_enum} alt="" className="size-9" /></div></>, sub: "Collects data" },
          { label: "", icon: "→", sub: "" },
          { label: "You", icon: <><div><img src={welcome_check} alt="" className="size-9" /></div></>, sub: "Validate records", highlight: true },
          { label: "", icon: "→", sub: "" },
          { label: "System", icon: <><div><img src={welcome_validate} alt="" className="size-9" /></div></>, sub: "Data confirmed" },
        ].map((item, i) => (
          item.label === "" ? (
          ...
          <div className="flex gap-3 text-xs text-gray-400">
            <span className="flex">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4 text-gray-400 mr-2">
               ...
               3 Enumerators</span>
            <span className="flex">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 text-gray-400 mr-2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
              </svg>
               5 Pending records</span>
          </div>
        </div>
        <div className="px-4 py-2 bg-amber-50 flex items-center gap-2">
          <span className="flex text-xs text-amber-600 gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-4 text-amber-500 text-xs">
              <path stroke-linecap="round" stroke-linejoin="round" d="m11.25 11.25.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
            </svg>
             You cannot create or edit project settings, only admins can.</span>
        </div>
      </div>
    ),
  },

  {
    ...
    visual: (
      <div className="mt-4 space-y-2">
        ...
        <p className="text-xs text-gray-400 text-center font-bold pt-1">Only approved families are eligible for deliveries</p>
      </div>
    ),
  },
